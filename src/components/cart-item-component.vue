    ...
    <div class="product-detail">
      <div class="detail-top">
        <div class="product-info">
          ...
          <p>Colore: </p>
          <p>Taglia: </p>
          <p v-if="isMobile"><span style="font-weigth: bold;">Prezzo:</span> {{total | numFormat}} &euro; </p>
        </div>
...
export default {
  ...
  methods: {
    ...
    removeCartItem() {
      this.$emit("removeCartItem", this.cartItem);
    },
    checkDiscounted() {
...
@media screen and (max-width:530px) {
  ...
  .buttons > button.del-btn {
    border-right: 1px solid  #e6e6e6;
  }

  .buttons > button.fav-btn {
