        ...
        <div id="nav-controller">
            ...
            <div class="nav-section header-icons">
                <div class="usermenu-container" data-name="login" @mouseenter="toggleMenu" @mouseleave="toggleMenu">
                    ...
                    <div id="login" class="menu" v-if="!loggedUser" ref="loginMenu">
                    ...
                    <div id="logout" v-if="loggedUser" @click="logout">
                        <span>Logout</span>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M8 10v-5l8 7-8 7v-5h-8v-4h8zm2-8v2h12v16h-12v2h14v-20h-14z"/></svg>
                    </div>                    
                </div>   
...
export default {
    ...
    computed: {
        ...mapState(['loggedUser', 'cart', 'isLoginForm'])
    },  
    methods: {
        ...mapActions(['logoutUserAction', 'updateGenderValue']),
        logout() {
...
#login > .login-options > li.login-item {
    display: block;
    padding: 5px 10px;
    white-space: nowrap;
}
