    ...
    <div id="nav-controller">
      ...
      <div class="nav-section">
        <h2
          ...
          :class="{ 'align-start': isLoginForm || windowLessThen900() }"
          @click="updateGender"
        >
